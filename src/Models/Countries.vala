        ...
        public static HashMap<string, string> map {
            get {
                if (_map == null) {
                    ...
                    _map["AX"] = NC_("Countries","Åland Islands");
                    ...
                    _map["CI"] = NC_("Countries","Côte d'Ivoire");
                    _map["HR"] = NC_("Countries","Croatia");
                    _map["CU"] = NC_("Countries","Cuba");
                    _map["CW"] = NC_("Countries","Curaçao");
                    ...
                    _map["VG"] = NC_("Countries","Virgin Islands");
                    _map["VI"] = NC_("Countries","Virgin Islands");
